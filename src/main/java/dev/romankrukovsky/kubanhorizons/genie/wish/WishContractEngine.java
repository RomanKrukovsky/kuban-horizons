...
/** Создаёт читаемый договор желания; исполнение выполняет общий безопасный runtime. */
    ...
    public static ItemStack createContractBook(ServerLevel level, Player player, String wish) {
        ...
        List<Filterable<Component>> pages = List.of(
                ...
                Filterable.passThrough(Component.literal(
                        "Loophole: a materially changed preview voids consent."))
        );
        ...
        player.sendSystemMessage(Component.translatable(
                "message.kubanhorizons.genie.contract_issued"));
        return book;
    }
}
