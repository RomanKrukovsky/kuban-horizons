...
final class KHBiomeTagsProvider extends BiomeTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider registries) {
        tag(BiomeTags.IS_OVERWORLD).add(KHBiomes.KUBAN_STEPPE);
        tag(net.neoforged.neoforge.common.Tags.Biomes.IS_PLAINS).add(KHBiomes.KUBAN_STEPPE);
        tag(net.neoforged.neoforge.common.Tags.Biomes.IS_TEMPERATE).add(KHBiomes.KUBAN_STEPPE);
        ...
        tag(BiomeTags.HAS_MINESHAFT).add(KHBiomes.KUBAN_STEPPE);
        tag(BiomeTags.HAS_RUINED_PORTAL_STANDARD).add(KHBiomes.KUBAN_STEPPE);
        tag(BiomeTags.HAS_PILLAGER_OUTPOST).add(KHBiomes.KUBAN_STEPPE);
        tag(BiomeTags.HAS_STRONGHOLD).add(KHBiomes.KUBAN_STEPPE);
        tag(BiomeTags.HAS_TRIAL_CHAMBERS).add(KHBiomes.KUBAN_STEPPE);
    }
}
