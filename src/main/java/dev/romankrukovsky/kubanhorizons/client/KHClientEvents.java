...
<<<<<<< Updated upstream
=======
    private static final KeyMapping.Category GENIE_KEYS =
            new KeyMapping.Category(KHIds.of("genie"));
    private static final KeyMapping OPEN_GENIE_DIALOG = new KeyMapping(
            "key.kubanhorizons.open_genie_dialog", InputConstants.KEY_G, GENIE_KEYS);
...
>>>>>>> Stashed changes
    ...
    static void onRegisterKeyMappings(RegisterKeyMappingsEvent event) {
        event.registerCategory(GENIE_KEYS);
    ...
    static void onRegisterRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(KHEntities.HERON.get(),
                context -> new WaterBirdRenderer(context, HERON_LAYER, "heron",
                        0.4F, false));
        event.registerEntityRenderer(KHEntities.MANUL.get(), ManulRenderer::new);
