...
public final class KHPalaceWorldgen {
    ...
    public static void bootstrapSet(BootstrapContext<StructureSet> context) {
        ...
        // Каждый чанк формально кандидат, но GeniePalaceStructure принимает
        // только (0, 0). Так нулевой чанк гарантированно проходит placement;
        // большой случайный spacing мог выбрать другой чанк и оставить мир без дворца.
        context.register(GENIE_PALACES, new StructureSet(
                structures.getOrThrow(GENIE_PALACE),
                new RandomSpreadStructurePlacement(1, 0, RandomSpreadType.LINEAR, 17420360)));
    }
}
