...
- **Желание, ставшее существом**: WishCreatureEntity («преврати желание в
  существо») — светящийся спутник, хранящий суть желания и неуязвимый к урону;
  тест genie_wish_creature.
...
- **Мультяшная анатомия в игровых событиях**: CartoonAnatomyEngine был
  доступен только в тесте; теперь подключён — рука тянется за стрелой при
  перехвате, сплющивание при взрыве TNT, выныривание из лампы при призыве.
