...
- `6ddf4e1` feat: add first-join Kuban guide
...
- Этап 5: следующие природные зоны, специализированная растительность,
  surface rules и структуры.

## Следующий конкретный шаг
1. Этап 5: плавни и лиманы (водные surface rules, растительность,
   совместимость с текущим world preset).
