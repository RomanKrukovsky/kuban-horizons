...
- Нет: этап 5 (пойма реки) завершён и покрыт тестами.

## Следующий конкретный шаг
1. Достижения: ветки рис/виноград/чай/сад.
2. Строительные блоки: саман, ракушечник, плетень (этап 7 частично).
3. Специализированные структуры поймы и плавней (этап 5, вторая половина).
