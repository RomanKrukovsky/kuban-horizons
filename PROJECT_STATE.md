...
- `a46424d` feat: add Kuban building materials (adobe, shell rock, wattle)
...
- [x] **Пойма реки**: заливной луг заменяет ванильную `river` в opt-in
      preset (замёрзшие реки остаются ванильными). Прибрежные деревья,
      ежевика, кувшинки и высокая трава; речная фауна плюс скот заливных
      пастбищ; речной ил (грязь/глина под водой, супесь на берегу) через
      surface rules; дикий рис на мелководье — второй источник культуры.
...
- `runGameTestServer`: **36/36** мода (37/37 с ванильным batch)
  (подсолнечник 5, пресс 3, плодородие 3, орошение 3, кукуруза 1, чай 1,
  рис 2, виноград 2, томат 1, плодовые деревья 3, сушилка 1, мельница 1,
  путеводитель 1, реестры 1, world preset 1, пойма реки 1,
  структуры поймы/плавней 1, дерево достижений 1, строительные материалы 4).
...
- Нет: специализированные структуры завершены, datagen идемпотентен,
  все GameTest'ы зелёные.

## Следующий конкретный шаг
1. Диагностика генерации структур и биомов (завершение этапа 5).
2. Остальное этапа 7: белёная штукатурка и наличники, черепица, керамика,
   звуковые ландшафты степи и плавней.
3. Полный smoke на dedicated server + 2 клиента.
