...
- Gameplay-срез и Ультимативные механики Джиннии: `runData` сгенерировал все модели/локализации; полный
  `runGameTestServer` — **60/60** обязательных тестов пройдены успешно (включая ироническую защиту,
  ложную смерть, мета-правила, гигантизм и память мира).
