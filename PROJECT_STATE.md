...
- `fc1d2a7` feat: add Kuban steppe world preset
...
- Этап 5: пойма реки, специализированная растительность и структуры.

## Следующий конкретный шаг
1. Этап 5: пойма реки (речная растительность и правила размещения).
