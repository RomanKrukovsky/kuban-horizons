...
- `runGameTestServer`: **35/35** мода (36/36 с ванильным batch)
  ...
  дерево достижений 1, строительные материалы 4).
...
- Нет: строительные материалы завершены, datagen идемпотентен,
  все GameTest'ы зелёные.

## Следующий конкретный шаг
1. Специализированные структуры поймы и плавней (этап 5, вторая половина).
