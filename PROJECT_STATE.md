...
- `3a13f0c` docs: refresh project state
...
- `runGameTestServer`: **29/29** (подсолнечник 5, пресс 3, плодородие 3,
  орошение 3, кукуруза 1, чай 1, рис 2, виноград 2, томат 1, плодовые
  деревья 3, сушилка 1, мельница 1, путеводитель 1, реестры 1,
  сериализация 1).
...
- Этап 5: выбор безопасного способа внедрения собственных биомов в
  multi-noise генерацию Minecraft 26.2 без обязательной зависимости.
...
2. Достижения: ветки рис/виноград/чай/сад.
3. Строительные блоки: саман, ракушечник, плетень (этап 7 частично).
4. Полный smoke на dedicated server + 2 клиента.
