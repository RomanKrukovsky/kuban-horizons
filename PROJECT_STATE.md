...
- Этап 5 завершён. Для дальнейших биомов и структур сохранять обязательную
  проверку глобального порядка features и свежего opt-in мира.

## Следующий конкретный шаг
1. Этап 7: белёная штукатурка и наличники.
2. Затем черепица, керамика и звуковые ландшафты степи и плавней.
