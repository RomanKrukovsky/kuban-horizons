...
# Текстуры мода, проверяемые общим правилом ART_BIBLE §2.
# Джинния и глечик здесь НЕ проверяются: у них своя, более строгая проверка
# в check_genie.py, привязанная к box-UV раскладке модели. Общий лимит
# оттенков к ним не применим — один семицветный градиент хвоста уже
# исчерпывает бюджет, рассчитанный на 64×32 развёртку птицы.
